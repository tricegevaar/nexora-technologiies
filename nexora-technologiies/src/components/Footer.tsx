...
export default function Footer() {
  ...
  return (
    <footer style={{ background: "#0D0D10", borderTop: "1px solid rgba(201,168,76,0.1)", position: "relative", overflow: "hidden" }}>
      {/* Top accent line */}
        ...
        <div className="footer-grid-responsive">
          ...
          <div className="footer-brand">
            <div style={{ marginBottom: "20px" }}>
              <Image src="/photos/nexLogo.png" alt="Nexora Technologies" width={170} height={62} style={{ height: "62px", width: "auto" }} />
            </div>
            <p style={{ color: "rgba(220,210,190,0.5)", fontSize: "13.5px", lineHeight: 1.75, marginBottom: "24px" }}>
              Engineering intelligent digital experiences for modern businesses. Secure, scalable and AI-powered solutions.
            </p>
            <div style={{ display: "flex", gap: "10px" }}>
              {[
                { href: "https://wa.me/27848744120", icon: <WhatsAppIcon />, hoverColor: "#25d366", label: "WhatsApp" },
                { href: "#", icon: <LinkedInIcon />, hoverColor: "#0077b5", label: "LinkedIn" },
                { href: "#", icon: <FacebookIcon />, hoverColor: "#1877f2", label: "Facebook" },
                ...
                <a
                  ...
                  onMouseLeave={(e) => {
                    e.currentTarget.style.color = "rgba(220,210,190,0.5)";
      ...
      {/* Bottom bar */}
      <div style={{ borderTop: "1px solid rgba(201,168,76,0.07)", padding: "18px 0" }}>
        <div className="container" style={{ padding: "0 24px" }}>
          <div className="footer-bottom-content">
            <p style={{ color: "rgba(220,210,190,0.3)", fontSize: "12.5px", margin: 0 }}>
              © {new Date().getFullYear()} Nexora Technologies. All rights reserved.
            </p>
            <div style={{ display: "flex", gap: "22px" }}>
              {["Terms of Service", "Privacy Policy", "Cookie Policy"].map((item) => (
                <Link key={item} href="#"
                  style={{ color: "rgba(220,210,190,0.3)", fontSize: "12.5px", textDecoration: "none", transition: "color 0.3s ease" }}
                  onMouseEnter={(e) => { e.currentTarget.style.color = "#C9A84C"; }}
                  onMouseLeave={(e) => { e.currentTarget.style.color = "rgba(220,210,190,0.3)"; }}
                >
                  {item}
                </Link>
              ))}
            ...
            <button
              ...
              style={{
                ...
                display: "flex", alignItems: "center", justifyContent: "center",
                color: "#C9A84C", cursor: "pointer", transition: "all 0.3s ease",
              }}
              onMouseEnter={(e) => { e.currentTarget.style.background = "rgba(201,168,76,0.14)"; e.currentTarget.style.transform = "translateY(-2px)"; }}
              onMouseLeave={(e) => { e.currentTarget.style.background = "rgba(201,168,76,0.06)"; e.currentTarget.style.transform = "translateY(0)"; }}
            >
              <ArrowUp size={15} />
            </button>
          </div>
